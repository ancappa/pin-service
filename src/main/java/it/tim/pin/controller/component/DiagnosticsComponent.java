package it.tim.pin.controller.component;
...
public class DiagnosticsComponent implements Ordered {
	...
	private static final Logger logger = LoggerFactory.getLogger(it.tim.pin.controller.component.DiagnosticsComponent.class);
	
	
	@SuppressWarnings("unchecked")
	@Around("execution(* it.tim.pin.web.PinController.*(..))")
